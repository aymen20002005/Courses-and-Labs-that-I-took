var x, x2, y, y1, y2, y3, xAxis, xAxis2, yAxis;
var priceLine, avgLine, area2;
var svg, focus, barsGroup, context, legend;

var priceChart;
var brush;

var margin = {top: 40, right: 50, bottom: 100, left: 40},
margin2  = {top: 210, right: 50, bottom: 20, left: 40},
width = window.innerWidth - margin.left - margin.right, // Get the window width and set it as the width of the chart
...
function createLineAndAreaGenerators() {
