...
def plot_loss(error_rate1, error_rate2, parameters, parameter_name):
    ...
    axes[0].set_title("Impact of train size on pretrained network")
    ...
    axes[1].set_title("Impact of train size on non-pretrained network")
...
if __name__ == "__main__":
    ...
    if args.action == "RBM":
        ...
        rbm.generate_image_rbm(X_BAD, Y_BAD, 2, nb_gibbs, True)
        ...
        dbn.generate_image_dbn(X_BAD, Y_BAD, 2, nb_gibbs, True)
        ...
        if args.arg1 == "test":
            ...
            for layer in nb_layers:
                ...
                dbn = DBN(config)
                dbn.train_dbn(bad, epochs_dnn, learning_rate, batch_size)
                dbn.generate_image_dbn(X_BAD, Y_BAD, 8, nb_gibbs, True)
        ...
        k = 9  # Choose a class and plot the probability
